export const dielectricsSphereTraceFragmentSource: string =
    `	#version 300 es
    ...
    void setUpScene() {
        ...
        spheres[3] = Sphere(vec3(-1.0, 0.0, 0.0), 0.5, Material(vec3(0.0, 0.0, 0.0), 0.0, 1.5, DIELECTRIC));
		spheres[4] = Sphere(vec3(-1.0, 0.0, 0.0), -0.45, Material(vec3(0.0, 0.0, 0.0), 0.0, 1.5, DIELECTRIC));
    }
